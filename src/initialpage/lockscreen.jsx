   ...
   render() {
      ...
      return (
        <div className="main-wrapper">
            <Helmet>
               <title>Lockscreen - Hive Attendance</title>
          ...
          <div className="account-content">
            ...
            <div className="container">
              ...
              <div className="account-logo">
                <a href="/hive_hrm/app/employees/dashboard"><img src={Applogo} alt="Dreamguy's Technologies" /></a>
              </div>
              {/* /Account Logo */}
                ...
                <div className="account-wrapper">
                  ...
                  <form action="/hive_hrm/app/employees/dashboard">
                    ...
                    <div className="account-footer">
                      <p>Sign in as a different user? <a href="/hive_hrm/register">Login</a></p>
                    </div>
                  </form>
                  {/* /Account Form */}
                </div>
