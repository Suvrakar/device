                      ...
                      {/* <table className="table table-striped custom-table datatable">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img src={Avatar_21} alt="" /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">Daniel Porter <span>Admin</span></a>
                              </h2>
                            </td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_02} /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">John Doe <span>Web Designer</span></a>
                              </h2>
                            </td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_09} /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">Richard Miles <span>Admin</span></a>
                              </h2>
                            </td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_10} /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">John Smith <span>Android Developer</span></a>
                              </h2>
                            </td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_05} /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">Mike Litorus <span>IOS Developer</span></a>
                              </h2>
                            </td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_11} /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">Wilmer Deluna <span>Team Leader</span></a>
                              </h2>
                            </td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/hive_hrm/app/profile/employee-profile" className="avatar"><img src={Avatar_19} alt="" /></a>
                                <a href="/hive_hrm/app/profile/employee-profile">Barry Cuda <span>Global Technologies</span></a>
                              </h2>
                            </td>
