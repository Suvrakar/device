             ...
             <div className="row align-items-center">
               ...
               <div className="col-auto float-right ml-auto">
                 ...
                 <div className="view-icons">
                   <a href="/hive_hrm/app/employee/allemployees" className="grid-view btn btn-link"><i className="fa fa-th" /></a>
                   <a href="/hive_hrm/app/employee/employees-list" className="list-view btn btn-link active"><i className="fa fa-bars" /></a>
                 </div>
               </div>
             </div>
           </div>
